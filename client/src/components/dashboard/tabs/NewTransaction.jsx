...
import { Button, Select, InputLabel, FormControl, InputAdornment, Input, MenuItem, Typography, TextField, CircularProgress, Paper, TableContainer, TableHead, Table, TableRow, TableCell, TableBody } from '@mui/material';
 ...
 * @param {number} transactionTotal total amount of new transaction (possibly filled in from back button press) 
...
function TransactionDetailsPage({setSplitPage, setTransactionTitle, currentGroup, groupPicklistContent, transactionTitle, transactionTotal, setTransactionTotal, submit}) {
    ...
    return (
        <div className="transaction-detail-page d-flex flex-column justify-content-center align-items-center padding-10 w-100 h-100" onLoad={() => checkSubmitEnable()}>
            <div className="hover-underline d-flex flex-row justify-content-start align-items-center p-3 w-100" onClick={() => setSplitPage("add-people")}>
                <ArrowBackIcon />
            ...
            <section className="transaction-detail-form d-flex flex-column justify-content-center align-items-center w-100">
            ...
            <section className="d-flex flex-row gap-10 m-5">
                ...
                <Typography variant="subtitle1">and split </Typography>
                <Button 
                    variant="contained"
                    endIcon={<KeyboardArrowDownIcon />} 
                >
